...
from_dir = "C:/Users/osezf/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/osezf/OneDrive/Desktop" #Create "Document_Files" folder in your Desktop and update the path accordingly.
